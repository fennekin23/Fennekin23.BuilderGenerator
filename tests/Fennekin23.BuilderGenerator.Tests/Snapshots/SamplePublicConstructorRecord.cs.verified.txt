...
namespace Fennekin23.BuilderGenerator.Tests.Samples
{
    ...
    /// <summary>
    public sealed partial class SamplePublicConstructorRecordBuilder
    {
        ...
        {
            return new Fennekin23.BuilderGenerator.Tests.Samples.SamplePublicConstructorRecord(stringProperty: _stringproperty, intProperty: _intproperty)
            {
